              ...
              <div className="mb-5">
                ...
                <div className="grid grid-cols-2 gap-3 ml-2">
                  ...
                  <div className="p-3 rounded-lg bg-white/[0.03] border border-white/5">
                    ...
                    <p className="text-xs text-gray-500 font-sans">서버 프로그래머 · 클라이언트 (일반) · 클라이언트 (유니티) · 클라이언트 (언리얼) · 엔지니어 · UI/UX · 애니메이션 · 사운드</p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-3">
                  ...
                  {[
                    ...
                    '테스트 버튼 아래 "입력 장치" 드롭다운에서 사용할 마이크를 선택',
                    '말을 하면 5개의 막대가 움직입니다',
                ...
                {[
                  {
                    ...
                    a: '브라우저 주소창 왼쪽 🔒 아이콘 → 마이크 권한을 "허용"으로 변경 후 페이지를 새로고침하세요. 사이드바 마이크 테스트에서 "입력 장치"를 올바른 마이크로 변경하고 테스트해보세요.',
                  },
                  {
                    q: '면접관 목소리가 들리지 않아요.',
